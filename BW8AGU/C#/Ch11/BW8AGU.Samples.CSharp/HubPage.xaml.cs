...
namespace BW8AGU.Samples.CSharp
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        private async void BrowseButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            FileInfo test = new FileInfo() { Name = file.Name, DateCreated = file.DateCreated, Path = file.Path, IsAvailable = (file.IsAvailable) ? loader.GetString("True") : loader.GetString("False") };
