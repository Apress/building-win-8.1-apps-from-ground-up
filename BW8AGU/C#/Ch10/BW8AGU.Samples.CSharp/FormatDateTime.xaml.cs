...
namespace BW8AGU.Samples.CSharp
{
    ...
    /// </summary>
    public sealed partial class FormatDateTime : Page
    {
        ...
        {
            DateTimeFormatter formatter = new DateTimeFormatter(HourFormat.Default, MinuteFormat.Default, SecondFormat.None);
