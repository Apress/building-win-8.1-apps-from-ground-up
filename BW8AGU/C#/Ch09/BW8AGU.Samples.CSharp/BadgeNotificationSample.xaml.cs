...
using LockScreenBackgroundTask;
using System;
...
namespace BW8AGU.Samples.CSharp
{
    ...
    /// </summary>
    public sealed partial class BadgeNotificationSample : Page
    {
        ...
        public BadgeNotificationSample()
        {
        ...
        private void OnRegisterBackgroundTaskClick(object sender, RoutedEventArgs e)
        {
            var task = BackgroundTaskRegistration.AllTasks.Any(t => t.Value.Name == "UpdateBadgetTask");
            if (!task)
            {
                BackgroundTaskBuilder builder = new BackgroundTaskBuilder();
                builder.Name = "UpdateBadgetTask";
                builder.SetTrigger(new TimeTrigger(15, false));
                builder.TaskEntryPoint = (typeof(LockScreenBadgeUpdateTask).FullName);
