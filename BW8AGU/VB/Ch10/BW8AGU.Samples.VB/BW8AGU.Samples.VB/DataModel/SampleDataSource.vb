Namespace Data
    ...
    Public Class SampleDataItem
        ...
        Public Sub New(uniqueId As String, noSample As String, title As String, subtitle As String, imagePath As String, description As String, content As String)
            Me.UniqueId = uniqueId
            Me.NoSample = noSample
            Me.Title = title
        ...
        Private _noSample As String
        Public Property NoSample As String
            Get
                Return _noSample
            End Get
            Set(value As String)
    ...
    Public Class SampleDataGroup
        ...
        Public Sub New(uniqueId As String, noSample As String, title As String, subtitle As String, imagePath As String, description As String)
            Me.UniqueId = uniqueId
            Me.NoSample = noSample
            Me.Title = title
            Me.Subtitle = subtitle
    ...
    Public NotInheritable Class SampleDataSource
        ...
        Private Async Function GetSampleDataAsync() As Task
            ...
            For Each groupValue As JsonValue In jsonArray
                ...
                Dim group As New SampleDataGroup(groupObject("UniqueId").GetString(), groupObject("NoSample").GetString(), groupObject("Title").GetString(), groupObject("Subtitle").GetString(), groupObject("ImagePath").GetString(), groupObject("Description").GetString())

                For Each itemValue As JsonValue In groupObject("Items").GetArray()
                    Dim itemObject As JsonObject = itemValue.GetObject()
                    group.Items.Add(New SampleDataItem(itemObject("UniqueId").GetString(), itemObject("NoSample").GetString(), itemObject("Title").GetString(), itemObject("Subtitle").GetString(), itemObject("ImagePath").GetString(), itemObject("Description").GetString(), itemObject("Content").GetString()))
                Next
