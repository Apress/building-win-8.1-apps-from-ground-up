...
''' </summary>
Public NotInheritable Class FormatDateTime
    Inherits Page
    ...
    Private Sub LoadDateTime()
        Dim formatter As DateTimeFormatter = New DateTimeFormatter(HourFormat.Default, MinuteFormat.Default, SecondFormat.None)
        DateNoSecondsTextblock.Text = formatter.Format(DateTime.Now)

        formatter = New DateTimeFormatter("longdate shorttime")
