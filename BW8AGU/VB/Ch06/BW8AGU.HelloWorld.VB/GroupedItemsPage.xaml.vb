...
Public NotInheritable Class GroupedItemsPage
    ...
    Public Sub New()
        ...
        AddHandler Me.SizeChanged,
            AddressOf GroupedItemsPage_SizeChanged
    End Sub
...
#End Region
    ...
    Private Sub GroupedItemsPage_SizeChanged(sender As Object, e As SizeChangedEventArgs)
        If e.NewSize.Width >= 500 Then
            'Set the appropriate VisualState declared in resource section
        Else
            'Set the appropriate VisualState declared in resource section
        End If
    End Sub
