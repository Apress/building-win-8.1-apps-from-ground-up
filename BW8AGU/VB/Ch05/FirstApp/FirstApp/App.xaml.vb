...
NotInheritable Class App
    ...
    Dim _coreWindow As CoreWindow

    Private Sub VisibilityChanged(sender As CoreWindow, args As VisibilityChangedEventArgs)
...
#End If
        ...
        'Attaches VisibilityChanged
        _coreWindow = CoreWindow.GetForCurrentThread()
        AddHandler _coreWindow.VisibilityChanged, AddressOf VisibilityChanged
