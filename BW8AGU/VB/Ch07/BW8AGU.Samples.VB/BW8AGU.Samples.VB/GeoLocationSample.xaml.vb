...
''' </summary>
Public NotInheritable Class GeoLocationSample
    Inherits Page
...
#End Region
    ...
    Private Sub OnStatusChanged(sender As Geolocator, args As StatusChangedEventArgs)
